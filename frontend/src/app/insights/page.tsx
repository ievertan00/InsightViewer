  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      <div className="flex justify-between items-center">
        <div>
           <h1 className="text-2xl font-bold text-gray-900">{t('aiInsightsTitle')}</h1>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1">
                    <label className="block text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">{t('aiModel')}</label>
                    <select 
                ...
                <div className="flex-1 bg-gray-50 p-4 rounded-lg">
                    <h4 className="text-xs font-bold text-gray-400 uppercase mb-2">{t('dataContext')}</h4>
            ...
            <div className="flex-1 p-8 lg:p-12">
                {isGenerating ? (
                    <div className="h-full flex flex-col items-center justify-center text-center space-y-4 py-20">
                        ...
                        <div>
                            <p className="text-lg font-bold text-gray-800">{t('synthesizing')}</p>
                            <p className="text-sm text-gray-500 max-w-xs mx-auto">{t('connectingTo')} {options.model_provider.toUpperCase()}...</p>
                        </div>
                    </div>
                ) : generatedReport ? (
