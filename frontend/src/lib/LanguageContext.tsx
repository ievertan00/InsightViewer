...
const translations: Translations = {
  en: {
    ...
    howToImportStep3Bullet2: "Ensure header row has years (e.g., 2023 Annual, 2023 Q1, 2023-01).",
  ...
  zh: {
    ...
    howToImportStep2Bullet2: "将提示词粘贴到 DeepSeek/ChatGPT/Claude。",
    ...
    howToImportStep3Bullet2: "确保表头行包含年份（如：2023 Annual, 2023 Q1, 2023-01）。",
    searchAShare: "搜索 A 股",
